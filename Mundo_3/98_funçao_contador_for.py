...
def contador(inicio, fim, passo):
    # Transforma PASSO em negativo para contagens regresivas.
    if inicio > fim and passo > 0:
        passo = -passo

    # Transforma PASSO em positivo para contagens positivas.
    elif inicio < fim and passo < 0:
        passo = -passo

    # Condiçao em caso do passo ser zero ou vazio.
    elif passo in (None, 0,):
        if inicio < fim:
            passo = 1
        else:
            passo = -1
